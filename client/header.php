		...
		<div class="navbar navbar-expand-sm navbar-main navbar-dark bg-custom  pr-0" id="navbar" data-primary>
			<div class="container-fluid p-0">
				...
				<a href="<?php echo __HOSTNAME__; ?>" class="navbar-brand" style="padding: 10px;">
                    ...
                    <img class="navbar-brand-icon" style="position: absolute; margin-top: 0px;" src="<?php echo __HOSTNAME__; ?>/template/assets/images/logo-text-white.png" width="50" height="50" alt="SIMRS Bintan">
                    <h3 style="padding-left: 60px !important; color: #fff;">SIMRS RSUD Bintan</h3>
				</a>
