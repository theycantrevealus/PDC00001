        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Resep Dibatalkan</li>
                </ol>
            </nav>
            <h4 class="m-0">Resep Dibatalkan</h4>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card">
                <div class="card-header card-header-large bg-white d-flex align-items-center">
                    <h5 class="card-header__title flex m-0">Pembatalan Resep Apotek</h5>
                </div>
