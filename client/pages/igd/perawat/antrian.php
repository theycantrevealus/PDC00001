		...
		<div class="flex">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo __HOSTNAME__; ?>/igd/"><b id="target_pasien"></b></a></li>
					<li class="breadcrumb-item active" aria-current="page">Assesmen Keperawatan</li>
				</ol>
			</nav>
			<h4>- Assesmen Awal</h4>
		</div>
		...
		<div class="col-lg-12 col-md-12">
			...
			<div class="card card-footer custom-card-footer">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="<?php echo __HOSTNAME__; ?>/rawat_jalan/perawat" class="btn btn-danger pull-right" id="btnBackAsesmen">
