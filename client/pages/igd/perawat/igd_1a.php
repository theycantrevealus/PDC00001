    ...
    <div class="col-lg">
        <div class="card">
            ...
            <div class="card-body tab-content">
                <div class="tab-pane active show fade" id="informasi_utama">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ol type="1" class="form-list-item">
                                ...
                                <li>
                                    ...
                                    <div class="row" style="margin-top: 50px; padding: 0px 50px; position: relative" id="nrs_2">
                                        <div class="col-md-12 scale-loader-image" id="scale-loader-image-bidan"></div>
                                        <div class="col-md-12" id="scale-loader-define-bidan"></div>
                                        <div class="col-md-12 scale-loader" id="scale-loader-bidan"></div>
                                        <div class="col-md-12">
                                            <input type="text" id="txt_nrs_bidan" class="slider">
                                        </div>
                                    </div>
                                </li>
                            </ol>
