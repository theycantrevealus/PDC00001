            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        <input id="macam_pembedahan" name="macam_pembedahan" class="form-control">
                          
                    </div>
                    <div class="form-group col-lg-6">
                        <label for="">Urgensi</label>
                        <input id="urgensi" name="urgensi" class="form-control">
                          
                    </div>
                    <div class="form-group col-lg-6">
                        <label for="">Luka Operasi</label>
                        <input id="luka_operasi" name="luka_operasi" class="form-control">
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-lg-12">
                        <textarea id="diagnosa_pra_bedah" name="diagnosa_pra_bedah" class="form-control" rows="5" placeholder="-"></textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-lg-12">
                        <textarea id="tindakan_bedah" name="tindakan_bedah" class="form-control" rows="5" placeholder="-"></textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-lg-12">
                        <textarea id="diagnosa_pasca_bedah" name="diagnosa_pasca_bedah" class="form-control" rows="5" placeholder="-"></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input id="cara_bius" type="text" name="cara_bius" class="form-control" placeholder="Cara Pembiusan">
                    </div>
                    <div class="form-group col-lg-6">
                        <label>Posisi Pasien</label>
                        <input id="posisi_pasien" type="text" name="posisi_pasien" class="form-control" placeholder="Posisi Pasien">
                    </div>
                    <div class="form-group col-lg-6">
                        <label>No. Implant</label>
                        <input id="no_implant" type="text" name="no_implant" class="form-control" placeholder="No. Implant">
                    </div>
                    <div class="form-group col-lg-6">
                        <label>Mulai</label>
    ...
    <div class="col-lg">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-lg-12">
                        <textarea id="komplikasi" name="komplikasi" class="form-control" rows="5" placeholder="-"></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        <input id="jaringan_patologi" name="jaringan_patologi" class="form-control">
                        
                    </div>
                    <div class="form-group col-lg-6">
                        <label>Asal Jaringan</label>
                        <input id="asal_jaringan" type="text" name="asal_jaringan" class="form-control" placeholder="Asal Jaringan">
                    </div>
                </div>
            </div>
        </div>
