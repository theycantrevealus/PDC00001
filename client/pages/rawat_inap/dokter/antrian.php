		...
		<div class="col-lg-12 col-md-12">
				...
				<ul class="nav nav-tabs nav-tabs-custom" role="tablist">
					...
					<li class="nav-item">
						<a href="#tab-2" class="nav-link " data-toggle="tab" role="tab" aria-selected="false">
							...
							Pemeriksaan Multi Organ
						</a>
					</li>
					<li class="nav-item">
						<a href="#tab-3" class="nav-link active" data-toggle="tab" role="tab" aria-selected="false">
							<span class="nav-link__count">
								03
			...
			<div class="card card-body tab-content">
				<div class="tab-pane show fade " id="tab-1">
					<?php require 'kaji_awal.php'; ?>
				</div>
				<div class="tab-pane show fade " id="tab-2">
					<?php require 'multi_organ.php'; ?>
				</div>
				<div class="tab-pane show fade active" id="tab-3">
					<?php require 'rekonsiliasi_obat.php'; ?>
				</div>
			...
			<div class="card card-footer">
				<div class="row">
					<div class="col-md-12">
						...
						<a href="<?php echo __HOSTNAME__; ?>/rawat_inap/dokter" class="btn btn-danger">
