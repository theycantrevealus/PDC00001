        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo __HOSTNAME__; ?>/rawat_inap/dokter">Rawat Inap</a>
                    </li>
        ...
        <div class="col-lg-12 col-md-12">
                ...
                <div class="card card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="col-md-2">
                            ...
                            <b id="nama_pasien"></b>
                            <br />
                            <span id="tempat_lahir_pasien"></span>, <span id="tanggal_lahir_pasien"></span> (<span
                                id="usia_pasien"></span> tahun)
                            <br />
                            ...
                            <div class="form-row" data-toggle="dragula">
                                    ...
                                    <div class="card form-row__card text-white bg-primary">
                                        <div class="card-body">
                                            <h6 class="text-white"><i
                                                    class="fa fa-band-aid"></i>&nbsp;&nbsp;&nbsp;Gelang Pasien</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md col-lg-3 handy print_manager" id="kartu">
                                    <div class="card form-row__card bg-success text-white">
                                        <div class="card-body">
                                            <h6 class="text-white"><i
                                                    class="fa fa-credit-card"></i>&nbsp;&nbsp;&nbsp;Kartu Pasien</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md col-lg-3 handy print_manager" id="kartu">
                                    <div class="card form-row__card bg-purple text-white">
                                        <div class="card-body">
                                            <h6 class="text-white"><i class="fa fa-flask"></i>&nbsp;&nbsp;&nbsp;Label
                                                Lab Pasien</h6>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="card">
                ...
                <div class="card-header card-header-tabs-basic nav" role="tablist">
                    <a href="#dokter" class="active" data-toggle="tab" role="tab" aria-controls="keluhan-utama"
                        aria-selected="true">Dokter</a>
                ...
                <div class="card-body tab-content" style="min-height: 100px;">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input id="filter_date" type="text" class="form-control"
                                                placeholder="Filter Tanggal" data-toggle="flatpickr"
                                                data-flatpickr-mode="range"
                                                value="<?php echo $yesterday->format("Y-m-d"); ?> to <?php echo $tomorrow->format("Y-m-d"); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <br /><br />
                                        <nav aria-label="CPPT Pagination" id="cppt_pagination"
                                            class="paginate_selection">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div style="padding: 50px;">
                                                            ...
                                                            <p style="padding: 10px;">Silahkan ubah filter pencarian
                                                                untuk mendapatkan data lain.</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <img style="width: 100%;" alt="no-data"
                                                            src="<?php echo __HOSTNAME__; ?>/template/assets/images/illustration/undraw_startled_8p0r.png" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane show fade" id="obat">
                        <div class="card">
                            ...
                            <div class="card-header card-header-tabs-basic nav" role="tablist">
                                <a href="#resep" class="active" data-toggle="tab" role="tab"
                                    aria-controls="keluhan-utama" aria-selected="true">Resep dan Racikan</a>
                                <a href="#riwayat_obat" class="" data-toggle="tab" role="tab"
                                    aria-selected="false">Riwayat Pemberian Obat</a>
                            </div>
                            <div class="card-body tab-content" style="min-height: 100px;">
