						...
						<table class="table table-bordered table-striped largeDataType" id="table-antrian-rawat-jalan" style="font-size: 0.9rem;">
							...
							<tbody>
								<tr>
									...
									<td>Admin Loket 1</td>
									<td>
										<a href='<?= __HOSTNAME__; ?>/rawat_inap/dokter/asesmen_awal/antrian' class='btn btn-sm btn-warning'><i class='fa fa-address-card' data-toggle='tooltip' title='Asesmen Awal'></i></a> 
