		...
		<div class="col-lg-12 col-md-12">
			<div class="z-0">
				<ul class="nav nav-tabs nav-tabs-custom" role="tablist">
					...
					<li class="nav-item">
						<a href="#tab-5" class="nav-link " data-toggle="tab" role="tab" aria-selected="false">
							<span class="nav-link__count">
								05
					...
					<li class="nav-item">
						<a href="#tab-6" class="nav-link active" data-toggle="tab" role="tab" aria-selected="false">
							<span class="nav-link__count">
								06								
								<b class="inv-tab-status text-success" id="status-5"><i class="fa fa-check-circle"></i></b>
							</span>
			...
			<div class="card card-body tab-content">
				...
				<div class="tab-pane show fade " id="tab-5">
