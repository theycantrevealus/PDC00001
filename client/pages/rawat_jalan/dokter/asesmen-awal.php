					...
					<div class="col-lg-6">
						<div class="row">
							<div class="form-group col-lg-6">
								...
								<div class="input-group input-group-merge">
									<input type="text" value="0" id="txt_tanda_vital_td" class="form-control form-control-appended" placeholder="Tekanan Darah" readonly />
							...
							<div class="form-group col-lg-6">
								...
								<div class="input-group input-group-merge">
									<input type="text" value="0" id="txt_tanda_vital_n" class="form-control form-control-appended" placeholder="Nadi" readonly />
									<div class="input-group-append">
										<div class="input-group-text">
											<span>x/menit</span>
										</div>
						...
						<div class="row">
							<div class="form-group col-lg-6">
								...
								<div class="input-group input-group-merge">
									<input type="text" value="0" id="txt_tanda_vital_s" class="form-control form-control-appended" placeholder="Suhu" readonly />
									<div class="input-group-append">
										<div class="input-group-text">
							...
							<div class="form-group col-lg-6">
								...
								<div class="input-group input-group-merge">
									<input type="text" value="0" id="txt_tanda_vital_rr" class="form-control form-control-appended" placeholder="Pernafasan" readonly />
									<div class="input-group-append">
										<div class="input-group-text">
											<span>x/menit</span>
										</div>
						...
						<div class="row">
							<div class="form-group col-lg-6">
								...
								<div class="input-group input-group-merge">
									<input type="text" value="0" id="txt_berat_badan" class="form-control form-control-appended" placeholder="Berat Badan" readonly />
									<div class="input-group-append">
										<div class="input-group-text">
											<span>kg</span>
										</div>
							...
							<div class="form-group col-lg-6">
								...
								<div class="input-group input-group-merge">
									<input type="text" id="txt_tinggi_badan" class="form-control form-control-appended" placeholder="Tinggi Badan" readonly />
									<div class="input-group-append">
										<div class="input-group-text">
											<span>cm</span>
										</div>
