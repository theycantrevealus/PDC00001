                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input id="filter_date" type="text" class="form-control" placeholder="Filter Tanggal" data-toggle="flatpickr" data-flatpickr-mode="range" value="<?php echo '2018-01-01'; ?> to <?php echo $tomorrow->format("Y-m-d"); ?>" />
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <br /><br />
