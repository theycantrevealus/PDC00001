                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ol type="1" class="form-list-item">
                                        <li>
                                            <h6>Gangguan Kebersihan Jalan Nafas</h6>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="simetris" value="s"/>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <ol type="1" class="form-list-item">
                                        ...
                                        <li>
                                            <h6>Penggunaan Otot<br />Bantu Pernafasan</h6>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="simetris" value="s"/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="simetris" value="s"/>
                                                        <label class="form-check-label">
                                                            Memonitor RR, Irama, Kedlmn Nafas
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                            ...
                            <tr>
                                    ...
                                    <ol type="1" class="form-list-item">
                                        ...
                                        <li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group input-group-merge">
                                                        <input type="text" name="tanda_vital_n" id="tanda_vital_n" class="form-control form-control-appended inputan" placeholder="TD" style="padding: 1px">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <small>mmHg</small>
                                                            </div>
                                ...
                                <td>
                                    <ol type="1" class="form-list-item">
                                        <li>
                                            <h6>Gangguan Keseimbangan Cairan dan Elektrolit</h6>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="simetris" value="s"/>
                                        ...
                                        <li>
                                            <h6>Gangguan Perfusi Jaringan Perifer</h6>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="simetris" value="s"/>
