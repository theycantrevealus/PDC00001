                    ...
                    <table class="table table-bordered largeDataType">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="form-inline">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail2">V:</label>
                                                            <input type="text" class="form-control" id="exampleInputName2" style="width: 60px" />
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ol type="1" class="form-list-item">
                                    <li>
                                        <h6>Gangguan Mobilitas Fisik</h6>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="simetris" value="s"/>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="simetris" value="s"/>
                                                    <label class="form-check-label">
                                                        Retrofleksi gavidarum incarcerata
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="simetris" value="s"/>
                                                    <label class="form-check-label">
                                                        Pemberian Cairan Infuse yg terlalu dingin
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
