		...
		<div class="flex">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Edit Terminologi Item Manager</li>
				</ol>
			</nav>
			<h1 class="m-0">Edit Terminologi Item</h1>
		</div>
	</div>
</div>
			...
			<div class="card card-form card-group-row__card">
				<div class="row no-gutters">
					<div class="col-lg-4 card-body">
						<p><strong class="headings-color">Pengubahan Data Terminologi</strong></p>
						<p class="text-muted">
