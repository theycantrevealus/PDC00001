                ...
                },
                {
                    "data" : null, render: function(data, type, row, meta) {
                        return "<div class=\"btn-group wrap_content\" role=\"group\" aria-label=\"Basic example\">" +
                            "<a href=\"" + __HOSTNAME__ + "/apotek/proses/antrian/" + row.uid + "/Rawat_Jalan\" class=\"btn btn-info btn-sm\">" +
            ...
            "columns" : [
                ...
                },
                {
                    "data" : null, render: function(data, type, row, meta) {
                        if(row.status_resep !== "D") {
                            return "<div class=\"btn-group wrap_content\" role=\"group\" aria-label=\"Basic example\">" +
                                "<a href=\"" + __HOSTNAME__ + "/apotek/proses/antrian/" + row.uid + "/Rawat_Inap\" class=\"btn btn-info btn-sm\">" +
                                "<span><i class=\"fa fa-check\"></i>Proses</span>" +
                                "</a>" +
                                "</div>";
                        } else {
