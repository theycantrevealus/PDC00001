	...
	$(function() {
		...
		function loadDetailResep(data) {
            ...
            for(var resepKey in data.detail)
            {
                ...
                if(
                    data.detail[resepKey].batch.length > 0 &&
                    data.detail[resepKey].batch !== undefined &&
                    data.detail[resepKey].batch !== null
                )
                {
                    ...
                    $(resepObatCell).append("<span>" + data.detail[resepKey].detail.nama + "</span>").append(resepObat);
                }
