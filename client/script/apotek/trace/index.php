                    ...
                    "data" : null, render: function(data, type, row, meta) {
                        if(row.departemen.uid === __POLI_INAP__) {
                            return "<div class=\"btn-group wrap_content\" role=\"group\" aria-label=\"Basic example\">" +
                                "<button class=\"btn btn-purple btn-sm btn-apotek-cetak\" jenis=\"Rawat Inap\" id=\"cetak_" + row.uid + "\">" +
                                "<span><i class=\"fa fa-print\"></i> Cetak</span>" +
                                "</button>" +
                                "</div>";
                        } else if(row.departemen.uid === __POLI_IGD__) {
                            return "<div class=\"btn-group wrap_content\" role=\"group\" aria-label=\"Basic example\">" +
                                "<button class=\"btn btn-purple btn-sm btn-apotek-cetak\" jenis=\"IGD\" id=\"cetak_" + row.uid + "\">" +
                                "<span><i class=\"fa fa-print\"></i> Cetak</span>" +
                                "</button>" +
                                "</div>";
                        } else {
