...
<script type="text/javascript">
    $(function() {
        ...
        var tableAntrianRawat= $("#table-antrian-rawat-jalan-perawat").DataTable({
            "ajax":{
                ...
                type: "POST",
                data: function(d) {
                    d.request = "get_antrian_asesmen_rawat_2";
                    d.pasien = __PAGES__[3];
                },
                headers:{
                    Authorization: "Bearer " + <?php echo json_encode($_SESSION["token"]); ?>
    ...
    $("#btnTambahAsesmenRawat").click(function() {
      ...
      $.ajax({
        ...
        data: formData,
        success: function(response) {
          location.href = __HOSTNAME__ + "/igdv2/perawat/antrian/" + response.response_package.response_values[0] + "/" + __PAGES__[3] + "/" + __PAGES__[4];
        },
        error: function(response) {
          console.log(response);
        }
