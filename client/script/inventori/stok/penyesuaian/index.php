          ...
          render: function(data, type, row, meta) {
            ...
            if (row.gudang_tujuan !== undefined && row.gudang_tujuan !== null) {
              if ((row.transact_table === "resep" || row.transact_table === "racikan") && row.gudang_tujuan.uid === __UNIT__.gudang) {
                ...
                if (row.gudang_asal.uid !== __UNIT__.gudang) {
                  solution = row.gudang_asal.nama;
                } else {
                  solution = row.transact_table;
                }
              }
            } else {
              if (row.gudang_tujuan === undefined || row.gudang_tujuan === null) {
            ...
            <div class="col-lg-12 card-body">
              <div class="row">
                ...
                <div class="form-group col-md-12">
                  ...
                  <table class="table">
                    <tr>
                      <td class="bg-danger" style="width: 50px !important;"> </td>
                      <td>Stok kurang</td>
                    </tr>
                    <tr>
                      <td class="bg-warning" style="width: 50px !important;"> </td>
                      <td>Stok berlebih</td>
                    </tr>
                    <tr>
                      <td class="bg-success" style="width: 50px !important;"> </td>
                      <td>Stok sesuai</td>
                    </tr>
                  </table>
                </div>
