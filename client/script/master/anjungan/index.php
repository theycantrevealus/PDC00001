<script type="text/javascript">
	$(function(){
		...
		var tableAnjungan = $("#table-anjungan").DataTable({
			"ajax":{
				url: __HOSTAPI__ + "/Inventori/anjungan",
				type: "GET",
				headers:{
		...
		$("body").on("click", ".btn-delete-anjungan", function(){
			...
			var conf = confirm("Hapus anjungan item?");
			if(conf) {
				$.ajax({
					url:__HOSTAPI__ + "/Inventori/master_inv_anjungan/" + uid,
		...
		$("#btnSubmit").click(function() {
			...
			if(nama != "") {
				...
				if(MODE == "tambah") {
					form_data = {
						"request": "tambah_anjungan",
						"nama": nama
					};
				} else {
					form_data = {
						"request": "edit_anjungan",
						"uid": selectedUID,
						"nama": nama
					};
				}
	...
	<div class="modal-dialog modal-md bg-danger" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modal-large-title">Tambah Anjungan</h5>
			...
			<div class="modal-body">
				<div class="form-group col-md-12">
					<label for="txt_no_skp">Nama Anjungan:</label>
