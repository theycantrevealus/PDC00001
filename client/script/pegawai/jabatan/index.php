...
<script type="text/javascript">
	$(function(){
        ...
        var TableListPegawai = $("#pegawai-jabatan").DataTable({
            processing: true,
            serverSide: true,
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="alert alert-soft-warning d-flex align-items-center card-margin" role="alert">
                            ...
                            <div class="text-body"><strong>Update Akses</strong> Akses semua pegawai dengan jabatan ini akan disamakan. MOHON BERHATI-HATI</div>
                        </div>
                    </div>
                    <div class="col-lg-6">
