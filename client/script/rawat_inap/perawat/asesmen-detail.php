            ...
            if (racikan.length > 0) {
              ...
              for (var a in racikan) {
                ...
                if (racikan[a].racikan_apotek.length > 0) {
                  ...
                  if (racikan[a].racikan_apotek[a] !== undefined) {
          ...
          console.log(response)
            ...
            "columns" : [
                ...
                },
                {
                    "data" : null, render: function(data, type, row, meta) {
                        // return "<div class=\"btn-group wrap_content\" role=\"group\" aria-label=\"Basic example\">" +
                        //     "<a href=\"" + __HOSTNAME__ + "/rawat_inap/perawat/antrian/" + row.uid + "/" + row.uid_pasien + "/" + row.uid_kunjungan + "\" class=\"btn btn-success btn-sm\">" +
