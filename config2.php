...
// 	define('__SYNC__', '192.168.99.240');
	//define('__SYNC__', '10.2.2.3');
	//define('__SYNC__', '10.3.3.41');
	//define('__SYNC__', '192.168.43.161');
	define('__SYNC_PORT__', '3100');

	/*define('__HOSTNAME__', 'http://192.168.43.108/simrs/client');
	define('__HOSTAPI__', 'http://192.168.43.108/simrs/api');
	define('__HOST__', 'http://192.168.43.108/simrs/');*/
	...
	*/
	...
	define('__PC_CUSTOMER_GROUP__', 'Pemerintah Provinsi Riau');
	...
	define('__SYSTEM_DOMAIN__', 'petalabumi.com');

	define('__APPS_NAME__', 'SIMS::Integrated v.2.0');
	define('__APLICARES__', 'https://dvlp.bpjs-kesehatan.go.id:8888/aplicaresws');

	
	//PTB
	//define('__KODE_PPK__', '0069R035');
	define('__DATA_API_LIVE_APLICARES__', 32435); //PTB Aplicares pakai yang ini
	define('__SECRET_KEY_LIVE_APLICARES_BPJS__', '2pAB5273E9');  //PTB Aplicares pakai yang ini
	...
	define('__BPJS_MODE__', 1); // 0 Offline, 1 Staging, 2 Live
	define('__BASE_LIVE_BPJS__', 'https://apijkn-dev.bpjs-kesehatan.go.id'); //PTB PAKE INI
	define('__BASE_STAGING_BPJS__', 'https://apijkn-dev.bpjs-kesehatan.go.id'); //PTB PAKE INI
	define('__KODE_PPK__', '0069R035');
	define('__BPJS_SERVICE_NAME_LIVE__', 'vclaim-rest-dev'); //PTB PAKE INI MODE DEV
	define('__BPJS_SERVICE_NAME_DEV__', 'vclaim-rest-dev'); //PTB PAKE INI MODE DEV
	define('__BPJS_SERVICE_NAME__', ((__BPJS_MODE__ === 2) ? __BPJS_SERVICE_NAME_LIVE__ : __BPJS_SERVICE_NAME_DEV__));
	define('__DATA_API_LIVE__', 15174); //PTB PAKE INI
	define('__DATA_API_STAGING__', 15174); //PTB PAKE INI
	define('__SECRET_KEY_LIVE_BPJS__', 'EvuxgRoLkv'); //PTB PAKE INI
	define('__SECRET_KEY_DEV_BPJS__', 'EvuxgRoLkv'); //PTB PAKE INI
	define('__USERKEY_LIVE_BPJS__', '3c09584911b4b1c67588063351952cc1'); //PTB PAKE INI
	define('__USERKEY_DEV_BPJS__', '3c09584911b4b1c67588063351952cc1'); //PTB PAKE INI
	define('__BASE_LIVE_BPJS_APLICARES__', 'https://new-api.bpjs-kesehatan.go.id'); //PTB PAKE INI
	...
	define('__UIDPENJAMINBPJS__','8509d734-22c3-421e-93c5-3de08fb0a506');
        define('__UIDPENJAMINBPJSOFFLINE__','c1297e5c-c31a-4892-b9ce-d5cff7f1b02e');
	...
	define('__UIDPETUGASLAB__', '08a29d1c-f1ed-4e62-95fd-858801e444bc');
	...
	define('__UIDKEPALAGUDANG__', '04629705-58da-4a24-9435-187fcd248b86');
	/*
	 * master_unit*/
	...
	define('__UID_KELAS_GENERAL_RI__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	...
	define('__UID_KELAS_GENERAL_IGD__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_JANGMED__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_BDRS__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_IRM__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_PSI__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_IPJ__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_LOUNDRY__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_CSSD__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_AMBULANCE__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_FARMASI__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	define('__UID_KELAS_GENERAL_GIZI__', '64c374d4-3d35-432d-ad3d-e4b3e7ec448a');
	...
	define('__UIDREHABMEDIK__', '77455ea2-7385-4b61-81d1-1513d95c5efc');
	define('__POLI_FISIOTERAPI__', '11f95113-a88c-49fe-908d-f260dd6906d8');
	define('__POLI_STROKE__', '11f95113-a88c-49fe-908d-f260dd6906d8');
	define('__POLI_DD__', '11f95113-a88c-49fe-908d-f260dd6906d8');
	define('__REHABILITASI_MEDIK__', '11f95113-a88c-49fe-908d-f260dd6906d8');
	...
	/*
	 * master_unit_ruangan*/
	// define('__KAMAR_IGD__', '99b6a15a-d567-4f04-9a64-39a85d87e1b8');
	define('__KAMAR_IGD__', '58b9320b-f53b-46c8-8f58-b89db7a218ab');


	/*
	 * master_mitra*/
	define('__MITRA_PTB__', '3d515c54-2433-3f2d-6865-9a1f150fe182');
	define('__WNI__', 1690);
	define('__RULE_PRA_INAP_ALLOW_ADMINISTRASI__', 1);
	define('__APOTEK_SERVICE_RESPONSE_TIME_TOLERATE__', 45);
