        ...
        <?php
            foreach ($_POST['data'] as $itemKey => $itemValue) {
                ...
                <tr>
                    ...
                    <td><?php echo $itemValue['tanggal_po']; ?></td>
                    <td><?php echo $itemValue['nama']; ?></td>
                    <td><?php echo $itemValue['item_detail']['satuan_terkecil_info']['nama']; ?></td>
                    <td><?php echo $itemValue['kategori_obat']['generik']; ?></td>
                    <td><?php echo $itemValue['kategori_obat']['narkotika']; ?></td>
                    <td><?php echo $itemValue['batch']; ?></td>
                    <td><?php echo $itemValue['expired_date']; ?></td>
