            ...
            <tr>
                <td>
                    <div class="report_content">
                        ...
                        <h1 class="title-name">HASIL RADIOLOGI</h1>
                        <br />
                        <hr />
                        <!--pre><?php print_r($_POST['rad_pasien']); ?></pre-->
                        <table class="form-mode largeDataType">
                            <tr>
                                <td class="wrap_content">Nama Pasien</td>
                                <td class="wrap_content">:</td>
                                <td><?php echo $_POST['rad_pasien']['pasien']['nama']; ?></td>

                                <td class="wrap_content">Permintaan Dokter</td>
                                <td class="wrap_content">:</td>
                                <td><?php echo $_POST['rad_pasien']['antrian']['dokter']['nama']; ?></td>
                            </tr>
                            <tr>
                                <td>No. MR</td>
                                <td class="wrap_content">:</td>
                                <td><?php echo $_POST['rad_pasien']['pasien']['no_rm']; ?></td>
                            ...
                            <tr>
                                <td>Tanggal Lahir</td>
                                <td class="wrap_content">:</td>
                                <td><?php echo $_POST['rad_pasien']['pasien']['tanggal_lahir_parsed']; ?>, <b>(<?php echo $_POST['rad_pasien']['pasien']['usia']; ?> tahun)</b></td>

                            </tr>
                            <tr>
                                <td>Alamat</td>
                                <td class="wrap_content">:</td>
                                <td><?php echo $_POST['rad_pasien']['pasien']['alamat']; ?></td>
